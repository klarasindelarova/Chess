...
public class Pawn extends Piece {
    ...
    public List<Integer> givePossibleMoves(ChessEngine engine, Piece[] pieces, int index) {
        ...
        if (this.colour.equals("BLACK")) {
            if (rowOfPiece == 6) {     //figurka muze v pristim tahu ziskat jednu z vyhozenych figurek
                giveMovesForAnyPositionExceptFirstRow(engine, pieces, directionsBlack, rowOfPiece, columnOfPiece, rowOfFutureMove,
                ...
                if (isPossibleToTakePieceInNextMove(engine, pieces, rowOfFutureMove, columnOfFutureMove)) {
                ...
                giveMovesForAnyPositionExceptFirstRow(engine, pieces, directionsBlack, rowOfPiece, columnOfPiece,
            ...
            if (rowOfPiece == 1) {      //figurka muze v pristim tahu ziskat jednu z vyhozenych figurek
                giveMovesForAnyPositionExceptFirstRow(engine, pieces, directionsWhite, rowOfPiece, columnOfPiece, rowOfFutureMove,
                        columnOfFutureMove, possibleMoves);
                // vratit zpet vyhozenou figurku
                ...
                giveMovesForAnyPositionExceptFirstRow(engine, pieces, directionsWhite, rowOfPiece, columnOfPiece,
                        rowOfFutureMove, columnOfFutureMove, possibleMoves);
            }
        }
    ...
    public boolean isPossibleToTakePieceInNextMove(ChessEngine engine, Piece[] pieces, int rowOfFutureMove, int columnOfFutureMove) {
    ...
    public void giveMovesForAnyPositionExceptFirstRow(ChessEngine engine, Piece[] pieces, int[][] directions, int RoP, int CoP,
